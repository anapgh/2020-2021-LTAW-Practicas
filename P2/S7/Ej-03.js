...
//-- En el caso de que sea un recurso distinto a los 3 establecidos
...
const server = http.createServer((req, res) => {
    ...
    switch (recurso) {
        //-- recurso raiz, devuelve pagina principal
        case '':
            console.log("Main page");
            content = MAIN;
            break;
        //-- Recurso pedidos, devuelve JSON
        case 'productos':
            ...
            break;
        //-- Recurso cliente 2
        //-- Lee el fichero js del cliente, y luego lo ejecutara el navegador.
        case 'cliente-2.js':
